...
import BetfairInteraction.Setup as bfi

trading = bfi.setupLogin("C:/Users/domt/Documents/BBetter/")
...
for event_type in horse_racing_event_type_id:
    ...
    for market_catalogue in market_catalogues:
        ...
        for runner in market_catalogue.runners:
            ...
            idHorse[runner.selection_id] = runner.runner_name
        ...
        for market_book in market_books:
            ...
            for runner in market_book.runners:
                ...
                print ("runner", idHorse[runner.selection_id])
                for toBack in available_to_back:
                    print("to back", toBack.price, toBack.size)
                for toLay in available_to_lay:
                    print("to lay", toBack.price, toBack.size)
                print()
